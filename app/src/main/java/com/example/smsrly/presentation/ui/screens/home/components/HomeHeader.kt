...
@Composable
fun HomeHeader(user: User?, userState : UserState,navController: NavController) {
    ...
    Row(
        ...
        IconButton({
            ...
            Icon(painter = painterResource(id = R.drawable.dm), contentDescription = "", modifier = Modifier.size(30.dp))
        }
    }
